...
let ticket1 = new Ticketbatch("Matthew", 1);
Ticketbatch.count++;

let ticket2 = new Ticketbatch("Mark", 12);
Ticketbatch.count++;

let ticket3 = new Ticketbatch("Luke", 3);
Ticketbatch.count++;

let ticket4 = new Ticketbatch("John", 4);
Ticketbatch.count++;

let ticket5 = new Ticketbatch("Acts", 5);
Ticketbatch.count++;
...
class Bible {
  bookName: string;
  chapterNumber: number;
  static count: number = 0; // ✅ Class-level (shared) variable
...
const bible1 = new Bible("Matthew", 1);
const bible2 = new Bible("Mark", 12);
const bible3 = new Bible("Luke", 3);
const bible4 = new Bible("John", 4);
const bible5 = new Bible("Acts", 5);
const bible6 = new Bible("Romans", 4);
const bible7 = new Bible("James", 5);
